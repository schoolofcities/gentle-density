...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-1c8ik1_START --><link href="${"https://fonts.googleapis.com/css2?family=Roboto&family=Source+Serif+Pro&display=swap"}" rel="${"stylesheet"}"><link href="${"https://fonts.googleapis.com/css2?family=Ubuntu+Mono:ital,wght@0,400;0,700;1,400;1,700&display=swap"}" rel="${"stylesheet"}"><link href="${"https://fonts.googleapis.com/css2?family=EB+Garamond:wght@400;800&display=swap"}" rel="${"stylesheet"}"><meta name="${"viewport"}" content="${"width=device-width, initial-scale=1, minimum-scale=1"}"><link href="${"https://api.mapbox.com/mapbox-gl-js/v2.10.0/mapbox-gl.css"}" rel="${"stylesheet"}">${$$result.title = `<title>Tracking Gentle Density in Toronto</title>`, ""}<meta name="${"description"}" content="${"Visualizing a decade (2013 to 2023) of Secondary Suite and Laneway / Garden Suite building permits in Toronto"}"><meta name="${"author"}" content="${"Jeff Allen"}"><meta property="${"og:title"}" content="${"Tracking Gentle Density in Toronto"}"><meta property="${"og:description"}" content="${"Visualizing a decade (2013 to 2023) of Secondary Suite and Laneway / Garden Suite building permits in Toronto"}"><meta property="${"og:type"}" content="${"website"}"><meta property="${"og:url"}" content="${"https://schoolofcities.github.io/gentle-density/toronto-building-permits"}"><meta property="${"og:image"}" content="${"https://raw.githubusercontent.com/schoolofcities/gentle-density/main/static/web-card.png"}"><meta property="${"og:locale"}" content="${"en_CA"}"><meta name="${"twitter:card"}" content="${"summary_large_image"}"><meta name="${"twitter:site"}" content="${"https://schoolofcities.github.io/gentle-density/toronto-building-permits"}"><meta name="${"twitter:creator"}" content="${"@JeffAllenMaps"}"><meta name="${"twitter:title"}" content="${"Tracking Gentle Density in Toronto"}"><meta name="${"twitter:description"}" content="${"Visualizing a decade (2013 to 2023) of Secondary Suite and Laneway / Garden Suite building permits in Toronto"}"><meta name="${"twitter:image"}" content="${"https://raw.githubusercontent.com/schoolofcities/gentle-density/main/static/web-card.png"}"><!-- HEAD_svelte-1c8ik1_END -->`, ""}
	...
	<div class="${"background-white"}"><div class="${"arrow"}"><p>\u25BC</p></div>
		...
		<div class="${"text"}"><p>Swaths of Toronto consists of low-density single family homes (these lands are often called the <a href="${"https://schoolofcities.github.io/yellowbelt-canadian-cities-2022/"}">Yellowbelt</a> due to the historical exclusionary zoning of these neighbourhoods). 
			...
			<div class="${"typeWrapper"}"><div class="${"isometric-mobile"}"><img${add_attribute("src", isometricLaneway, 0)} alt="${"isometricLaneway"}"></div>
				...
				<div class="${"isometric"}"><img${add_attribute("src", isometricLaneway, 0)} alt="${"isometricLaneway"}"></div></div>

			<h3><span class="${"textLaneway"}">Multiplexes</span></h3>
			<p>Allowing for multiplexes was passed in May 2023 in neighbourhoods city-wide. However, at the time of writing, it is too early to track their completion from building permit data. We are planning on updating this website, including tracking multiplex development across the city, in early 2024.
			</p></div></div>
