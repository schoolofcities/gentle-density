<script>
    ...
    // data
    import torontoLostDwellings from '../assets/toronto/lost-units-2017-2023.geo.json';
    // import victoriaLostDwellings from '../assets/victoria/';
    // import edmontonLostDwellings from '../assets/edmonton/';
    // import calgaryLostDwellings from '../assets/calgary/';
    ...
    const cityData = {
        'Toronto': {
            ...
            // lostDwellings: torontoLostDwellings,
            maxBounds: [
                [-80.0, 42.0], // SW coords
                [-78.6, 49.5] // NE coords
            ],
        ...
        'Victoria': {
            ...
            // lostDwellings: victoriaLostDwellings,
            maxBounds: [
        ...
        'Edmonton': {
            ...
            // lostDwellings: edmontonLostDwellings,
            maxBounds: [
        ...
        'Calgary': {
            ...
            // lostDwellings: calgaryLostDwellings,
            maxBounds: [
    ...
    function loadmap(cityname) {
        ...
        map.on('load', function() {
            ...
            map.addSource('lostDwellings', {
				'type': 'geojson',
				'data': torontoLostDwellings //cityData[cityname].lostDwellings
			}); 
			map.addLayer({
