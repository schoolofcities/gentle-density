<script>
	...
	import MapV from "../lib/MapVictoriaLoss.svelte";
	import MapC from "../lib/MapCalgaryLoss.svelte";
	import MapE from "../lib/MapEdmontonLoss.svelte";
    import MapT from "../lib/MapTorontoLoss.svelte";
