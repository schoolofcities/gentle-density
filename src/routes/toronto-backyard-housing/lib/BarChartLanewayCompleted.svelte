...
<div id="barChart" bind:offsetWidth={divWidth}>
    ...
    <svg height=400 width={svgWidth} id="svgChart">
        ...
        <text 
            ...
            y="13"
            id="title"
        >Completed "New Laneway / Rear Yard</text>
        <text 
            x="20" 
            y="37"
            id="title"
        ...
        <pattern id="pattern-lines-green" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">            
            <rect x="0" y="0" height="10" width="10" style="fill:#8DBF2E" />
        ...
        {#each yLabels as yLabel}
            ...
            <line x1="70" y1="{280 - yLabel}" x2="{svgWidth}" y2="{280 - yLabel}" style="stroke:white;stroke-width:1;opacity:0.2" />
            <text x=60 y={285 - yLabel} id="label">{yLabel}</text>

        {/each}
        
		<line x1="70" y1="280" x2="{svgWidth}" y2="280" style="stroke:white;stroke-width:1;opacity:0.89" />
